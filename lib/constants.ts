...
export const ACTIVITY_MULTIPLIERS = { 'low-cardio': 1.35, 'standard': 1.45, 'high-activity': 1.55 };
...
export const BUILTIN_PROGRAMS: {
  ...
  {
    program: { name: 'Foundation Strength', source: 'builtin', lengthWeeks: 12, daysPerWeek: 3 },
    workouts: [
      {
        dayLabel: 'A',
        exercises: [
