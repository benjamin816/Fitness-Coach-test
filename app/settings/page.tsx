...
export default function SettingsPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <button onClick={handleReset} className="w-full py-4 text-red-600 border-2 border-dashed border-red-100 rounded-2xl font-bold flex items-center justify-center space-x-2 hover:bg-red-50 transition-colors">
        <Trash2 size={18} /><span>Wipe All Local Data</span>
      </button>
    </div>
  );
}
